...
function extractEventName(event: ResourceDataType<RoutableResource>): string {
            ...
            <div>
              {resource === Resource.AcademicSemesters ? (
                <>
                  <CreateButton
                    className="mt-4 mr-2"
                    resource={Resource.DaySwaps as RoutableResource}
                    prefillAttributes={{}}
                    asSheet
                    onClick={() => {
                      showSheet(
                  ...
                  <CreateButton
                    className="mt-4"
                    resource={Resource.Holidays as RoutableResource}
                    prefillAttributes={{}}
                  />
                </>
              ) : (
