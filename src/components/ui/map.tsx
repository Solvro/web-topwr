...
function MapPopup({
  ...
  return (
    <LeafletPopup
      className={cn(
        "bg-popover text-popover-foreground animate-in fade-out-0 fade-in-0 zoom-out-95 zoom-in-95 slide-in-from-bottom-2 border-input z-50 w-72 rounded-md border p-4 font-sans shadow-md outline-hidden",
        className,
      )}
      {...props}
    />
...
function MapTooltip({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "bg-foreground fill-foreground absolute z-50 size-2.5 rotate-45 rounded-md",
  ...
  return (
    <>
      <Button
        type="button"
        size="icon-sm"
        variant={position ? "default" : "input"}
...
function MapDrawShapeButton<T extends Draw.Feature>({
  ...
  return (
    <Button
      ...
      title={`Draw ${drawMode}`}
      className={className}
      variant={isActive ? "default" : "input"}
