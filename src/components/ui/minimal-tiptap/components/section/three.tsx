...
const COLORS: ColorPalette[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      { cssVar: "var(--mt-accent-blue-subtler)", label: "Niebieski subtelny" },
      { cssVar: "var(--mt-accent-teal-subtler)", label: "Turkusowy subtelny" },
      { cssVar: "var(--mt-accent-green-subtler)", label: "Zielony subtelny" },
      { cssVar: "var(--mt-accent-yellow-subtler)", label: "Żółty subtelny" },
      { cssVar: "var(--mt-accent-red-subtler)", label: "Czerwony subtelny" },
      {
        cssVar: "var(--mt-accent-purple-subtler)",
        label: "Fioletowy subtelny",
      },
    ],
  },
];
