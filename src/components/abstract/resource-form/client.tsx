                      ...
                      >
                        <div className="flex-col items-start">
                          ...
                          <MultiSelect
                            ...
                            options={relationData.data.map(
                              ({ data }, index) => {
                                const label =
                                  config.itemMapper(data).name ??
                                  JSON.stringify(data);
                                const value = String(
                                  get(
                                    data,
                            ...
                            onCreateItem={() => {
                              setSheet({
                                ...
                                content: {
                                  ...
                                  form: relationData.createForm,
                                },
                              });
                            }}
                            onEditItem={(value) => {
                              const relationItem = relationData.data.find(
                                ({ data }) =>
                                  value === String(get(data, primaryKeyField)),
                              );
                              if (relationItem == null) {
                                toast.error(
                                  "Nie znaleziono elementu do edycji. Proszę zgłosić ten błąd wraz z informacją o tym, co próbowałeś edytować.",
                                );
                                return;
                              }
                              setSheet({
