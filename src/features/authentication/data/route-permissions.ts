...
export const ROUTE_PERMISSIONS = {
  ...
  [`/${Resource.Das}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasConfig}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasLinks}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasMaps}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasStands}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasTimetables}`]: ANY_AUTHENTICATED_ROLE,
  [`/${Resource.DasTimetableEntries}`]: ANY_AUTHENTICATED_ROLE,
