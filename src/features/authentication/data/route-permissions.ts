...
export const ROUTE_PERMISSIONS = {
  ...
  [`/${Resource.RegularHours}`]: ["user", "admin"],
  [`/${Resource.Roles}`]: ["user", "admin"],
  [`/${Resource.SksOpeningHours}`]: ["user", "admin"],
  [`/${Resource.SpecialHours}`]: ["user", "admin"],
  [`/${Resource.StudentOrganizations}`]: ["user", "admin"],
  [`/${Resource.StudentOrganizationLinks}`]: ["user", "admin"],
  [`/${Resource.StudentOrganizationTags}`]: ["user", "admin"],
  [`/${Resource.Versions}`]: ["user", "admin"],
  [`/${Resource.VersionScreenshots}`]: ["user", "admin"],
