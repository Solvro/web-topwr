...
function isAcademicSemesterWithDaySwaps(
  semester: ResourceDataType<RoutableResource>,
): boolean {
  return (
...
export function checkAcademicSemesterEvents(
  semester: GetResourceWithRelationsResponse<RoutableResource>["data"],
  targetDate: Date,
...
export type DaySpecificEvent<T extends RoutableResource> =
